...
public class Ex33{
	public static void start(){
		FastTraversalLinkedList<Integer> ftll = new FastTraversalLinkedList<Integer>();
		ListPerformance33.start();
	}
}

class FastTraversalLinkedList<E> extends LinkedList<E>{
	...
	public boolean add(E e){
		return al.add(e) && super.add(e);
	}
	public boolean addAll(Collection col){
		return al.addAll(col) && super.addAll(col);
	}
